...
class GraphServlet extends WebSocketServlet {
  ...
  //settings.classpath.value = classpathstringer
  //  settings.usejavacp.value = true
  //settings.Ycompletion.value = true
  //val interpreter = new Interpreter(settings) {
  //  override def reset() = { super.reset; unleash() }
  //  override def unleash() = { super.unleash; bind("servlet", "nextgen.patterns.actorWebUI", GraphServlet.this) }
  //}
  //interpreter.unleash()
